...
public class WhileTest01 {
	...
	public static void main(String[] args) {
		...
		int i = 1;
		while (destination!=car) { //destination과 car가 같지 않으면 계속수행
			car = car + speed;
			i++;
		} //while 문이 한번 돌때 마다 1초가 지나는 것입니다. 60번돌면 1분이지나겠죠?
		System.out.println(i+"번"); //3758번 while 문을 수행했습니다. 분으로 환산해 보겠습니다.
		int min = i/60;
		...
		System.out.println(hour+"시간"+real_min+"분"); //완성
